...
#' @rdname accessor-methods
setMethod('freq', signature(object='MFCLLenFreq2'),function(object) return(slot(object, 'freq')))
#' @rdname accessor-methods
...
#' @rdname accessor-methods
setMethod('cateffpen', signature(object='MFCLLenFreq'),function(object) return(slot(object, 'cateffpen')))
#' @rdname accessor-methods
setGeneric('cateffpen<-', function(object, ..., value) standardGeneric('cateffpen<-'))
#' @rdname accessor-methods
setReplaceMethod('cateffpen', signature(object='MFCLLenFreq', value=unname(getSlots('MFCLLenFreq')['cateffpen'])),
                 function(object, value){slot(object, 'cateffpen') <- value; return(object)})
#' @rdname accessor-methods
setGeneric('lnfrq', function(object, ...) standardGeneric('lnfrq'))
#' @rdname accessor-methods
setMethod('lnfrq', signature(object='MFCLLenFreq'),function(object) return(slot(object, 'lnfrq')))
#' @rdname accessor-methods
setGeneric('lnfrq<-', function(object, ..., value) standardGeneric('lnfrq<-'))
#' @rdname accessor-methods
setReplaceMethod('lnfrq', signature(object='MFCLLenFreq', value=unname(getSlots('MFCLLenFreq')['lnfrq'])),
                 function(object, value){slot(object, 'lnfrq') <- value; return(object)})
#' @rdname accessor-methods
setGeneric('wtfrq', function(object, ...) standardGeneric('wtfrq'))
#' @rdname accessor-methods
setMethod('wtfrq', signature(object='MFCLLenFreq'),function(object) return(slot(object, 'wtfrq')))
#' @rdname accessor-methods
setGeneric('wtfrq<-', function(object, ..., value) standardGeneric('wtfrq<-'))
#' @rdname accessor-methods
setReplaceMethod('wtfrq', signature(object='MFCLLenFreq', value=unname(getSlots('MFCLLenFreq')['wtfrq'])),
