...
corLabel <- function(x)
{
  ...
  A[x >= -1.000 & x < -0.999] <- "---"  # [) beyond 0.999
  A[x >= -0.999 & x < -0.990] <- "--"   # [) beyond 0.99
  A[x >= -0.990 & x < -0.900] <- "-"    # [) beyond 0.9
  A[x >= -0.900 & x <= 0.900] <- "."    # []
  A[x >   0.900 & x <= 0.990] <- "+"    # (] beyond 0.9
  A[x >   0.990 & x <= 0.999] <- "++"   # (] beyond 0.99
  A[x >   0.999 & x <= 1.000] <- "+++"  # (] beyond 0.999
  lab <- c("+++", "++", "+", ".", "-", "--", "---")
